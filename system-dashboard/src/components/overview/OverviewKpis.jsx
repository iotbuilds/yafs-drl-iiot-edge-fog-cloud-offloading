...
export default function OverviewKpis({ kpis }) {
  ...
  const cards = [
    { title: 'Total IIoT Sensors', value: kpis.totalNodes, icon: Server, color: 'bg-blue-500/10', trend: 'stable', tooltip: 'Total sensors deployed across the industrial plant' },
    { title: 'Active Sensors', value: kpis.activeNodes, icon: CheckCircle, color: 'bg-emerald-500/10', trend: trends.activeNodes || 'stable', tooltip: 'Sensors operating within normal parameters' },
    { title: 'Warning Sensors', value: kpis.warningNodes, icon: AlertTriangle, color: 'bg-amber-500/10', trend: trends.warningNodes || 'stable', tooltip: 'Sensors with readings approaching thresholds' },
    { title: 'Critical Sensors', value: kpis.criticalNodes, icon: AlertOctagon, color: 'bg-red-500/10', trend: trends.criticalNodes || 'stable', tooltip: 'Sensors with readings exceeding critical thresholds' },
